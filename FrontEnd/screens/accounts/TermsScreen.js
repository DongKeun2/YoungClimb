      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.textBox}>
          ...
          <Text style={styles.text}>
            ...
            Climb')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고
            있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용
            목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의
            동의를 받는 등 필요한 조치를 이행할 예정입니다. 1. 홈페이지 회원가입
            및 관리 회원 가입의사 확인, 회원제 서비스 제공에 따른 본인
          ...
          <Text style={styles.text}>
            ...
            연락·통지 목적으로 개인정보를 처리합니다.
          </Text>
          <Text style={styles.text}>
            3. 재화 또는 서비스 제공 서비스 제공, 콘텐츠 제공, 맞춤서비스 제공을
            목적으로 개인정보를 처리합니다.
          </Text>
          <Text style={styles.text}>
            4. 마케팅 및 광고에의 활용 신규 서비스(제품) 개발 및 맞춤 서비스
            제공, 인구통계학적 특성에 따른 서비스 제공 및 광고 게재 , 서비스의
            유효성 확인, 접속빈도 파악 또는 회원의 서비스 이용에 대한 통계 등을
            목적으로 개인정보를 처리합니다.
          </Text>
          ...
          <Text style={styles.text}>
            ① {'<'} Young Climb {'>'}은(는) 법령에 따른 개인정보 보유·이용기간
          ...
          <Text style={styles.text}>
            • 보유근거 : 회원관리를 위해 회원 탈퇴 후 1년간 회원 정보를 보관할
            수 있습니다.
          </Text>
          ...
          <Text style={styles.text}>
            ① {'<'} Young Climb {'>'}은(는)개인정보 보유기간의 경과, 처리목적
          ...
          <Text style={styles.text}>
            ...
            선정하고, {'<'} Young Climb {'>'} 의 개인정보 보호책임자의 승인을
            받아 개인정보를 파기합니다.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            로그인을 하시면 됩니다. 또한, 휴면계정으로 전환되었더라도 로그인을
            하는 경우 이용자의 동의에 따라 휴면계정을 복원하여 정상적인 서비스를
            이용할 수 있습니다
          </Text>
          ...
          <Text style={styles.text}>
            ...
            하실 수 있으며 Young Climb은(는) 이에 대해 지체 없이 조치하겠습니다.
          </Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.text}>
            ⑥ Young Climb은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
          ...
          <Text style={styles.text}>
            {'<'} Young Climb {'>'}은(는) 개인정보의 안전성 확보를 위해 다음과
            같은 조치를 취하고 있습니다.
          </Text>
          <Text style={styles.text}>1. 해킹 등에 대비한 기술적 대책</Text>
          <Text style={styles.text}>
            {'<'} Young Climb {'>'}('Young Climb')은 해킹이나 컴퓨터 바이러스
          ...
          <Text style={styles.text}>
            Young Climb 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
          ...
          <Text style={styles.text}>
            {'<'} Young Climb {'>'}에서는 비슷한 클라이머 정보의 게시물을 추천,
            제공하기 위하여 다음과 같은 민감정보를 수집 및 이용하고 있습니다.
          </Text>
          <Text style={styles.text}>민감정보</Text>
          <Text style={styles.text}>
            민감정보 수집 목적 : 개인정보 활용을 통한 회원 군집화 및 정보 맞춤
            추천
          </Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.text}>
            귀하께서는{'<'} Young Climb {'>'}의 민감정보 수집 및 이용에 대한
            동의 거부권이 있으며 동의 거부 시에는 맞춤 정보 추천 등 Young
            Climb의 일부 서비스를 이용할 수 없습니다.
          </Text>
        </View>
      </ScrollView>
