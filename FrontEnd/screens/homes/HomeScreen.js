  ...
  const boards = [
    {
      ...
      isScrap: false,
      commentNum: 2753,
      commentPreview: {nickname: '아그작냠냠', comment: '개쩌네... 어떻게 했냐 으아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아아ㅏ앙'},
    },
    {
      id: 2,
      createUser: '0_climb',
    ...
    },
    {
      ...
      content: 'T1이 이기겠지..? 이길거야 징동 T1 무서워했다며.. 실력으로 보여줄거야 구마유시 믿는다 황마유시 대상혁도 나오면 더 좋고ㅎ 진짜 무조건 이겨야 해 그래야 Lck 내전 본다~',
      like: 968,
      view: 3160,
      isFollow: true,
      isLiked: false,
