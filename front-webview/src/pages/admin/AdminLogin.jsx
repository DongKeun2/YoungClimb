...
import { fetchCurrentUser, changeIsLoggedIn } from '../../reducer/slice/UserSlice'
  ...
  return (
    <div className='height100'>
      ...
      <div className='loginDiv'>
        <div className='loginText'><div>ADMIN LOGIN</div></div>
        <div className='inputDiv'>
          <div className='inputContentDiv'>
            <div className='subtext'><div>ID</div></div>
            <input 
              name='email'
          ...
          <div className='inputContentDiv'>
            <div className='subtext'><div>PW</div></div>
          <input 
            name='password'
            className='loginInput'
            type="password"
